...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    die("Invalid categoryId."); // If category ID is not set or empty, display error message and terminate script
}

// Instantiate Food class with database connection
...
if ($deleteResult === true) {
    ...
    die("Error deleting category."); // If category deletion fails, display error message and terminate script
}
