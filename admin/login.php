          ...
          <div class="card-body">
            ...
            <form id="loginForm" action="model/login_process.php" method="post">
              <div class="mb-3">
                ...
                <span id="emailError" class="error-message text-danger">
                  <!-- Email error messages will be shown here -->
                </span>
              </div>
              <div class="mb-3">
                ...
                <span id="passwordError" class="error-message text-danger">
                  <!-- Password error messages will be shown here -->
                </span>
              </div>
              <div class="mb-3">
